...
Those taking the course for credit can satisfy the requirement for written work in one of two ways: a typical class paper, or, a pair of review essays. See the [Assignments]({{< baseurl >}}/sections/assignments) section for further details.
